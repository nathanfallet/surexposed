...
publishing {
    ...
    publications.withType<MavenPublication> {
        ...
        pom {
            name.set("surexposed")
            description.set("Definitions and extensions for Exposed databases.")
            url.set("https://github.com/nathanfallet/surexposed")
            ...
            scm {
                url.set("https://github.com/nathanfallet/surexposed.git")
            }
        }
    }
}
